...
export default function ModalEdit({ isopen, onClose, endpoint, inputData, titleModal }) {
    ...
    useEffect(() => {
        if (isopen) {
            axios.get(endpoint['data_detail'].replace('{id}', dataDetail.id), {
                headers: {
    ...
    function handleUpdate(e) {
        ...
        const { id, ...updateData } = dataDetail; // Exclude id from update data

        axios.patch(endpoint['update'].replace('{id}', id), updateData, {
            headers: {
                'Authorization': 'Bearer ' + localStorage.getItem('token'),
            }
        })
