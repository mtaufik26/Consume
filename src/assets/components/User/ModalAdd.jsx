...
export default function ModalAdd({ isOpen, onClose, endpoint, inputData, titleModal }) {
    const [payload, setPayload] = useState({
        ...
        email: '',
        password: '',
        role: '' // Tambahkan field role di sini
    });
                                        ...
                                        item.tag === "select" ? (
                                            <>
                                                ...
                                                <select id={index} name={index} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" onChange={handleInputChange}>
                                                    ...
                                                    {
                                                        Array.isArray(item['option']) ? item['option'].map((opt, optIndex) => (
                        ...
                        <button type="button" onClick={handleStore}
                            ...
                            <svg className="me-1 -ms-1 w-5 h-5" fill="currentColor" viewBox="0 0 20 20"
                                ...
                                <path fillRule="evenodd"
                                    d="M10 5a1 1 0 011 1v3h3a1 1 0 110 2h-3v3a1 1 11-2 0v-3H6a1 1 110-2h3V6a1 1 11-1-1z"
